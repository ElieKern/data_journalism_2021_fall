...
**Answer**
Nevada had the largest percentage growth.
...
**Answer**
	Howard County, Maryland, has the highest median household income.
...
**Answer**
Possibly.  While Calvert's estimated household income is slightly greater than Montgomery's, the Margin of error for Calvert is almost 4 times more than Montgomery.  
Is the difference between Howard and everyone else significant?
**Answer**
Yes, even with the MOE, Howard is still well above the next closest county.
...
**Answer**
Somerset County and Caroline County saw their median incomes fall from 2010-2019, and the change is within the margin of error for both.
```{r}
md10 %>%
...
Of the 20 zip codes with the largest amounts, 3 have incomes of less than $50,000. 21202 has an estimate of 47848, 21740 has an estimate of 48372, and 21201 has an estimate of 37687.
